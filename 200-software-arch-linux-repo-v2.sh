...
sudo pacman -S --noconfirm --needed nfirefox-i18n-pt-pt
sudo pacman -S --noconfirm --needed thunderbird-i18n-pt-pt
...
sudo pacman -S --noconfirm --needed smplayer smplayer-themes
